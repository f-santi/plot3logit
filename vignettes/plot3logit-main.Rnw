...
\author{Flavio Santi~\orcidlink{0000-0002-2014-1981}\\University of Trento
   \And Maria Michela Dickson~\orcidlink{0000-0002-4307-0469}\\University of Trento
...
\begin{figure}[t]
\centering
<<visualization, echo=FALSE, fig=TRUE, height = 4, width=4>>=
ptsAB <- list(A = c(0.3, 0.4, 0.3), B = c(0.5, 0.1, 0.4))
par(mfrow = c(2, 2), cex = 0.5, mar = rep(0, 4))
plot(field3logit(modVote, "genderFemale", edge = 0.1))
plot(field3logit(modVote, "genderFemale", nstreams = 4))
...
are actually needed, the\break `\code{multifield3logit}` object can be subsetted through
the S3 method \code{"["}.
...
the syntax when a `\code{field3logit}` or a `\code{multifield3logit}` object
