...
@santi2022 or in the main vignette of the package [based on @santi2022].
...
The paper published on *Journal of Statistical Software* [@santi2022] is also
available as a package vignette (updated):
```{r, eval = FALSE}
