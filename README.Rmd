...
package `ggtern` (Hamilton 2018) which, in turn, is based on the `ggplot2`
...
`TernaryField`, and in particular by the `plot` method of `field3logit`
objects.
...
Statistician*. https://doi.org/10.1080/00031305.2018.1442368
